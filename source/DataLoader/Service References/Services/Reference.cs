...
namespace DataLoader.Services {
    ...
    public interface IGraphManagementService {
        ...
        DataLoader.Services.GraphNode GetGraphNode(string id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IGraphManagementService/GetGraphNode", ReplyAction="http://tempuri.org/IGraphManagementService/GetGraphNodeResponse")]
        System.Threading.Tasks.Task<DataLoader.Services.GraphNode> GetGraphNodeAsync(string id);
    ...
    public partial class GraphManagementServiceClient : System.ServiceModel.ClientBase<DataLoader.Services.IGraphManagementService>, DataLoader.Services.IGraphManagementService {
        ...
        public DataLoader.Services.GraphNode GetGraphNode(string id) {
            return base.Channel.GetGraphNode(id);
        }
        
        public System.Threading.Tasks.Task<DataLoader.Services.GraphNode> GetGraphNodeAsync(string id) {
